...
class CommonPlatform ():
    PackagesSupported = ("rmx2202Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('rmx2202', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "rmx2202", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "rmx2202Pkg/rmx2202.dsc", "Platform Hardcoded")
